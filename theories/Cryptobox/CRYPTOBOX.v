...
Lemma move_AE :
ID (GMODPKAE.I_GMODPKAE_ID_COMP N) || ((MODPKAE.MODPKAE N E) ∘ (NIKE_scheme.NIKE N || AE.AE N)) ≡ ID (GMODPKAE.I_GMODPKAE_ID_COMP N) || ((MODPKAE.MODPKAE N E) ∘ (NIKE_scheme.NIKE N || (ID AE.I_AE_OUT E N))). ∘ (ID ?? || AE.AE N).
