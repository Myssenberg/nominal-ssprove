...
Definition GMODPKAE (E : NBSES_scheme) (N : NIKE_scheme) (I : inj 'shared_key N 'k E) qset (b : 'bool) :
  raw_module := (ID (I_GMODPKAE_ID_COMP N) || ((MODPKAE N E) ∘ ((NIKE N || AE E N I b)))) ∘ ((PKEY (NIKE_to_GEN N) true || KEY N qset b)).

Lemma GMODPKAE_valid (E : NBSES_scheme) (N: NIKE_scheme) (I : inj 'shared_key N 'k E) qset (b : 'bool) : ValidPackage (GMODPKAE E N I qset b).(loc) [interface] (I_GMODPKAE_OUT N E) (GMODPKAE E N I qset b).
Proof.
