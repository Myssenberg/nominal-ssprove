...
#[export] Hint Unfold (*I_GH_OUT*) I_GH_ID_COMP I_HYBRID_IN I_HYBRID_OUT I_AE_IN I_AE_OUT I_KEY_OUT I_SAE_OUT I_GSAE_OUT: in_fset_eq.
...
Lemma GAE_HYBRID_perfect {E N} qset {I : NIKE.inj ('shared_key N) ('k E)} b : perfect (I_GAE_OUT E N)
  (GAE E N qset I b) (HYBRID E N I (if b then 0 else qset) qset ∘ (ID (I_GSAE_OUT E) || (KEY N qset true) ) ∘ GSAE E true).
Proof.
(*unfold GAE, GSAE.
nssprove_share.
...
Theorem Lemma3_Adv_GAE {E N} qset (I : NIKE.inj ('shared_key N) ('k E)) (A : adversary (I_GAE_OUT E N)) :
  AdvFor (GAE E N qset I) A <= \sum_(0 <= i < qset) AdvFor (GSAE E) (A ∘ HYBRID E N I i qset ∘ ((ID (I_GSAE_OUT E)) || (KEY N qset true))).
Proof.
